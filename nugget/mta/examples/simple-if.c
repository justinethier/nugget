 ...
 */
/* 
(begin (if #t (display #t) (display #f)))
 */
/* 
"---------------- after desugar:"
 */
...
/* 
((lambda (k$2)
   (if #t (k$2 (display #t)) (k$2 (display #f))))
 (lambda (r$1) (%halt r$1)))
 */
/* 
"---------------- after wrap-mutables:"
...
((lambda (k$2)
   (if #t
     ((%closure-ref k$2 0) k$2 (display #t))
     ((%closure-ref k$2 0) k$2 (display #f))))
 (%closure (lambda (self$3 r$1) (%halt r$1))))
 */
/* 
"---------------- C code:"
 */
/* 
DEBUG: (c-compile-app: ((lambda (k$2) (if #t ((%closure-ref k$2 0) k$2 (display #t)) ((%closure-ref k$2 0) k$2 (display #f)))) (%closure (lambda (self$3 r$1) (%halt r$1))))) */
/* 
DEBUG: (c-compile-app: (if #t ((%closure-ref k$2 0) k$2 (display #t)) ((%closure-ref k$2 0) k$2 (display #f)))) */
/* 
DEBUG: (c-compile-app: ((%closure-ref k$2 0) k$2 (display #t))) */
/* 
DEBUG: (c-compile-app: (%closure-ref k$2 0)) */
/* 
DEBUG: (c-compile-app: (display #t)) */
/* 
DEBUG: (c-compile-app: ((%closure-ref k$2 0) k$2 (display #f))) */
/* 
DEBUG: (c-compile-app: (%closure-ref k$2 0)) */
/* 
DEBUG: (c-compile-app: (display #f)) */
/* 
...
static void __lambda_0(closure1 k) { // Need to know closure1 somehow?
 ...
 // if, quote_t, _75closure_91ref, k_732, MakeInt(0)));, k_732, prin1(quote_t)));, _75closure_91ref, k_732, MakeInt(0)));, k_732, prin1(quote_f)));));; 
}
