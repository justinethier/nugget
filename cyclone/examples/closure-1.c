...
/* 
DEBUG: (c-compile-app: (%closure-ref r$3 0)) */
/* 
...
/* 
DEBUG: (c-compile-app: (%closure-ref k$4 0)) */
/* 
...
//
// JAE - editing generated code below to make it work, then need to
//       fold these changes back into the compiler
//
...
static void __lambda_3(closure1 self_735, closure k_734, object y_932) {
    make_cons(cons1, self_735->elt1, y_932);
    (k_734->fn)(k_734, &cons1); // TODO: return_funcallX
...
// TODO: should use final cont (my_exit) instead of halt, which will be obsolete
...
static void test(env,cont) closure env,cont; { 
  return_check(__lambda_4(quote_t)); // TODO: should have passed cont
}
