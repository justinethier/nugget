...
csc browse.scm      && time ./browse      < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/browse.input
...
csc deriv.scm       && time ./deriv       < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/deriv.input
csc destruc.scm     && time ./destruc     < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/destruc.input
csc diviter.scm     && time ./diviter     < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/diviter.input
csc divrec.scm      && time ./divrec      < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/divrec.input
...
csc ntakl.scm       && time ./ntakl       < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/ntakl.input
csc ntalk.scm       && time ./ntalk       < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/ntalk.input
csc peval.scm       && time ./peval       < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/peval.input
csc puzzle.scm      && time ./puzzle      < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/puzzle.input
csc simplex.scm     && time ./simplex     < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/simplex.input
csc tak.scm         && time ./tak         < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/tak.input
csc takl.scm        && time ./takl        < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/takl.input
csc triangl.scm     && time ./triangl     < ~/Documents/larceny/test/Benchmarking/R7RS/inputs/triangl.input
